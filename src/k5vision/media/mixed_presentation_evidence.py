"""Source-free physical evidence for bounded mixed live/playback presentation."""
...
from k5vision.media.mixed_presentation import MixedPresentationState


class MixedPresentationPhysicalEvidence(BaseModel):
    ...
    final_state: MixedPresentationState


def write_evidence(path: pathlib.Path, evidence: MixedPresentationPhysicalEvidence) -> None:
