"""Source-free physical evidence for the bounded presentation runtime assembly."""
...
from k5vision.media.presentation_runtime import PresentationRuntimeState


class PresentationRuntimePhysicalEvidence(BaseModel):
    ...
    final_state: PresentationRuntimeState


def write_evidence(path: pathlib.Path, evidence: PresentationRuntimePhysicalEvidence) -> None:
