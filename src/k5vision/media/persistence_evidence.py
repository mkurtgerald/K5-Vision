"""Source-free evidence for Stage-08 local-persistence qualification."""
...
class LocalPersistenceEvidence(BaseModel):
    """Retained proof that bounded live RTP persistence finalized and was deleted."""
    ...
    def accepted(self) -> bool:
        return (
            self.sink_state == FileSinkState.FINALIZED
            and self.delivered_bytes == self.persisted_bytes
            and self.delivered_packets > 0
