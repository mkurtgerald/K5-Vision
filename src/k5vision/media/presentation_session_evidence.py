"""Source-free physical evidence for bounded operator presentation sessions."""
...
from k5vision.media.presentation_session import PresentationSessionState


class PresentationSessionPhysicalEvidence(BaseModel):
    ...
    final_state: PresentationSessionState


def write_evidence(path: pathlib.Path, evidence: PresentationSessionPhysicalEvidence) -> None:
